  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push('/search?type=found_persons')
      } else {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Reportar Persona Encontrada</h1>
              <p className="text-gray-600">Danos los detalles de la persona que encontraste</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-lg font-semibold text-gray-900 mb-2">
                9. Fotos de la persona (opcional)
              </label>
